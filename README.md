...
- 서비스 아이디어 및 주요 기능·사용자 흐름 기획
- 실제 배포 환경에서 반복적으로 사용하며 문제 발견 및 개선
- 일정 등록 후 상태 미반영, 날짜·시간대 오류, 반응형 UI 문제 등 검증
- 기능 변경 시 기존 사용자 흐름에 미치는 영향 확인
- 발견한 문제와 개선 과정을 날짜별로 README에 기록
