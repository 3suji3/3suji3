...
<table align="center">
  <tr>
    <td align="center">
      <img src="https://github.com/user-attachments/assets/df5826e4-d0ec-4c9d-a270-02eb0ef1f76b" 
           alt="프로필 사진" 
           width="200"
...
### 안녕하세요😊  
매일 성장하는 거북이🐢 같은 프론트엔드 개발자 신수지입니다!

React를 중심으로 사용자 경험을 고려한 웹 개발을 공부하고 있습니다.  
단순히 기능을 구현하는 것을 넘어서 더 나은 구조와 사용성을 고민하는 개발자가 되고 싶습니다.

아직은 배우는 단계지만, 꾸준함과 실행력을 바탕으로 성장하고 있습니다.
